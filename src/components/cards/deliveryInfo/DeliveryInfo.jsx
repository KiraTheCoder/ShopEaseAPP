...
const DeliveryInfo=()=>{
    ...
    <>
        <div className="w-[35rem] flex justify-between flex-wrap">
            <div className="w-[8rem] bg-slate-100 flex flex-col items-center py-2 rounded-xl border-[1px] border-gray-800 cursor-pointer hover:bg-gray-200 shadow-[0_0_8px_2px_rgba(0,0,0,0.7)] ...">

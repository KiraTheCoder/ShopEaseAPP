...
import CreateBillingAdd from "../createBillingAdd/CreateBillingAdd";

function BillingAddress({ selectedAddress, setSelectedAddress }) {
        ...
        <>
          ...
          <div className='my-2'>
            ...
            <p className="font-bold text-blue-500">
              <Link to={"/createbillingadd"}>New Address</Link>
            </p>
          </div>
        </>
      )}
...
export { BillingAddress, useFetchUserAddress };

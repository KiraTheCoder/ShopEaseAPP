        ...
        <div className=" w-auto p-1">
            ...
            <div className='my-2 '>
                <div className='flex gap-5 flex-wrap border my-2 items-end'>
                    ...
                    <div className=""><li className='list-none text-[10px] text-[#db4444] underline'>Modify name</li></div>
                </div>
                <div className='flex gap-5 flex-wrap border my-2 items-end'>
                    <ShowFieldData heading={"Email"} data={"example@gmail.com"} />
                    <ShowFieldData heading={"Mobile No"} data={"Mobile No"} />
                    <div className=""><Link to={"/updateAdd"} className='list-none text-[10px] text-[#db4444] underline'>Modify / Add email</Link></div>
                </div>
                <div className='flex gap-5 flex-wrap border my-2 items-end'>
                    <ShowFieldData heading={"Password"} data={"•••••••••••••••"} />
                    <div className=""><Link to={"/forgetpassword"} className='list-none text-[10px] text-[#db4444] underline'>Modify password</Link></div>
                </div>
            </div>
        </div>
    )

    ...
    return (
        <>
            ...
            <ul>
                ...
                <li className="text-[13px] sm:text-[15px] md:text-[16px] my-2 text-[#fafafa]"><NavLink to={'/cart'} target="#" className={({ isActive }) => ` relative after:content-[''] after:absolute after:left-0 after:bottom-0 after:h-[1.3px] sm:after:h-[1.5px] md:after:h-[2px] after:w-1/2 after:bg-[#db4444] pb-[0.18rem] ${isActive ? 'after:block' : 'after:hidden'}`}>Cart</NavLink></li>
                <li className="text-[13px] sm:text-[15px] md:text-[16px] my-2 text-[#fafafa]"><NavLink to={'/wishlistproducts'} target="#" className={({ isActive }) => ` relative after:content-[''] after:absolute after:left-0 after:bottom-0 after:h-[1.3px] sm:after:h-[1.5px] md:after:h-[2px] after:w-1/2 after:bg-[#db4444] pb-[0.18rem] ${isActive ? 'after:block' : 'after:hidden'}`}>Wishlist</NavLink></li>
                <li className="text-[13px] sm:text-[15px] md:text-[16px] my-2 text-[#fafafa]"><NavLink to={'/'} target="#" className={({ isActive }) => ` relative after:content-[''] after:absolute after:left-0 after:bottom-0 after:h-[1.3px] sm:after:h-[1.5px] md:after:h-[2px] after:w-1/2 after:bg-[#db4444] pb-[0.18rem] ${isActive ? 'after:block' : 'after:hidden'}`}>Shop</NavLink></li>
            </ul>
        </>
    )
}

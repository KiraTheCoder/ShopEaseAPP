...
// import { postData, getData } from "@/services/apiCall";
// import { useGetProduct, useGetCount, useAuthStore } from "@/services/zustandStore/zustandStore";
// import { FaPlus, FaMinus } from "react-icons/fa6";
// import { toast } from 'react-toastify';
// import { useNavigate } from "react-router-dom";
// import ItemsCollection from "../ItemsCollection/ItemsCollection";
...
//     const Product = useGetProduct((state) => state.product) || {};
//     const { images = [], discount = 0, price = 0, productName = "", description = "", color = "", _id } = Product;
//     const MRP = Math.ceil(price / (1 - discount / 100));
//     const [mainImg, setMainImg] = useState(images?.[0]);
...
//             const addProduct = await addProductPromise;
//             if (addProduct.success) {
//                 const cartCountResponse = await getData("/user/products/cart_products_count");
//                 setCount(cartCountResponse?.data?.productCartsCount);
//             }
//         } catch (error) {
//             toast.error("No response received or other error: " + error?.message);
//         }
